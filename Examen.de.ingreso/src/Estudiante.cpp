...
Estudiante::Estudiante(int _edad,string _nombre,int _DNI,string _pais,string _carrera_deseada):persona(_edad,_nombre,_DNI,_pais),
...
void Estudiante::personales(){// En caso de no estar la persona se pediran que se ingresen los datos y luego se mostraran
    ...
    cout<<"tengo "<<edad<<" años "<<" mi nombre es "<<nombre<<" , mi DNI es "<<DNI<<" y vengo de "<<pais<<
